   ...
   <div class="container">
      ...
      <div class="row mt-3">
         <section class="col-12 col-md-4 text-center p-4">
            ...
            <div class="card">
               <img src="{{asset('uploads/'.$curso->url_profile)}}" class="card-img-top circle-profile" alt="{{$curso->name}}">
               <div class="card-body text-center">
                 <h5 class="card-title"> <strong>{{$curso->name}}</strong><br><small class="text-minimalist text-secondary"> {{$curso->jobtitle}} </small></h5>
